...
```bash
cp -r upkuajing-customs-trade-company-search ~/.openclaw/workspace/skills/
```

2. 或者创建符号链接：
```bash
ln -s /path/to/upkuajing-customs-trade-company-search ~/.openclaw/workspace/skills/
```
...
```bash
cp -r upkuajing-customs-trade-company-search ~/.claude/skills/
```
